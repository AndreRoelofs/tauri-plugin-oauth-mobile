...
android {
    compileSdk = 36
    namespace = "com.appauth.example"
    defaultConfig {
        manifestPlaceholders["usesCleartextTraffic"] = "false"
        // AppAuth-Android registers an intent-filter on its own
        // RedirectUriReceiverActivity using this manifest placeholder. The
        // example demos the Duende sandbox, so its scheme is the default. To
